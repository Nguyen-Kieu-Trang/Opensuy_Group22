...
<header>
    ...
    ?>
            ...
            <div class="search">
                <form action="teach.php?id2=<?php echo $params['id2'];?>&role=<?php echo $params['role'];?>" method="GET" id="searchForm">
...
<?php
            ...
            $sql = "SELECT * FROM teacher $search $sort_ranked_option ORDER BY Rank+0" ;
...
?>
        ...
        <div class="teacher-search">
            ...
            ?>
                        ...
                        <td><a href="teacher_detail.php?id=<?php echo $row['TeacherID'] ?>&id2=<?php echo $params['id2'];?>&role=<?php echo $params['role'];?>"><?php echo $row["Avg_score"]?> </a> </td>
